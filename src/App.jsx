    ...
    <>
      ...
      >
        <div
          className={`${
            isDarkMode
              ? "bg-gray-800 text-white border-r-gray-700"
              : "bg-gray-100 text-gray-900 border-r-gray-300"
          } shadow-lg border-r transition xl:block hidden`}
        >
          <Navbar isDarkMode={isDarkMode} />
        </div>
        <div className="flex flex-col gap-10 w-full">
          <Header isDarkMode={isDarkMode} handleMode={handleMode} />
          <div className="flex justify-center gap-10 container flex-col lg:flex-row">
            <CategoryPieChart
