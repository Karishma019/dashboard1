...
const App = () => {
  ...
  return (
    <div className="bg-gray-900 text-white grid grid-cols-[1fr,auto] h-screen">
      <div className="bg-gray-800 text-white z-50 shadow-lg border-r border-r-gray-700 text-center relative">
        <Navbar />
      </div>
      <div>
        <Header />
